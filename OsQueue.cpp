...
*  @return ... .
*/
ERtosResult TOsQueue::Create(u8 lenght, u8 size_element)
{
	if(this->QueueHandle != NULL)
	{
		return(OsResult_ErrorCreateResource);
	}
	if((lenght > TASK_QUEUE_MAX_LENGHT) || (size_element > TASK_QUEUE_MAX_SIZE_ELEMENT))
	{
		return(OsResult_ErrorCreateResource);
	}
...
*  @return ... .
*/
ERtosResult TOsQueue::Receive(void* p_buffer, TickType_t timeout)
{
...
*  @return ... .
*/
ERtosResult TOsQueue::Send(void* p_buffer, TickType_t timeout)
{
